...
// pings dont work yet /MBeausencourt
...
// important for cloning, resubmits and recicling
...
typedef bit<16> McastGrp_t; // MCast for Broadcast
...
control MyIngress(inout headers hdr,
	...
	action broadcast() {
                //basically Multicast to Group 1
		standard_metadata.mcast_grp = 1;
                //meta.ingress_metadata_nhop_ipv4 = hdr.ipv4.dstAddr;
